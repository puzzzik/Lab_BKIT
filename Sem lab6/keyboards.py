...
uni = ReplyKeyboardMarkup(row_width=2, one_time_keyboard=False, resize_keyboard=True)
uni1 = KeyboardButton(text='идти в университет')
uni2 = KeyboardButton(text='пойду в колледж')
uni.add(uni1, uni2)

work = ReplyKeyboardMarkup(row_width=2, one_time_keyboard=False, resize_keyboard=True)
...
die = ReplyKeyboardMarkup(row_width=1, one_time_keyboard=False, resize_keyboard=True).add(diebtn)
